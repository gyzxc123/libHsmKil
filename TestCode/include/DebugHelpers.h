...
#if !MSCGEN && !defined(NO_DEBUG)
#undef MSC_WARNING
#undef MSC_NOTE
#undef MSC_ERROR
#ifdef USING_PRINTF
#define DBG_OUT_NEWLINE				puts("")
#else
#define DBG_OUT_NEWLINE				((void)0)
#endif
#define MSC_WARNING(control, msg, arg...)	DBG_OUT1(msg, ##arg); DBG_OUT_NEWLINE
#define MSC_NOTE(control, msg, arg...)		DBG_OUT1(msg, ##arg); DBG_OUT_NEWLINE
#define MSC_ERROR(control, msg, arg...)		DBG_ERR1(msg, ##arg); DBG_OUT_NEWLINE
#endif
